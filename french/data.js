...
const FLASHCARDS = [
    { prompt: "Si j'avais su, je ne ________ pas venu.", answer: "serais", explanation: "Condicional present amb 'être' — estructura clau: Si + plus-que-parfait → conditionnel présent." },
    { prompt: "Il faut que tu ________ tes devoirs. (faire)", answer: "fasses", explanation: "Subjuntiu present de 'faire' — 'Il faut que' sempre demana subjuntiu." },
    { prompt: "Bien qu'il ________ fatigué, il travaille. (être)", answer: "soit", explanation: "Subjuntiu present de 'être' — 'Bien que' sempre va amb subjuntiu." },
    { prompt: "Après ________ mangé, il est parti. (avoir)", answer: "avoir", explanation: "Infinitiu passat — Après + avoir/être + participi passat." },
    { prompt: "Je doute qu'il ________ demain. (venir)", answer: "vienne", explanation: "Subjuntiu present de 'venir' — 'douter que' demana subjuntiu." },
    { prompt: "Si j'________ de l'argent, je voyagerais. (avoir)", answer: "avais", explanation: "Imperfet — estructura: Si + imparfait → conditionnel présent." },
    { prompt: "Il ________ en 1900. (naître – passé simple)", answer: "naquit", explanation: "Passat simple de 'naître' — temps literari per a accions puntuals en narrativa escrita." },
    { prompt: "Nous ________ déjà mangé quand tu es arrivé. (avoir)", answer: "avions", explanation: "Plusquamperfet — auxiliar 'avoir' a l'imperfet + participi passat. Marca anterioritat." },
    { prompt: "Je voudrais que vous ________ attention. (faire)", answer: "fassiez", explanation: "Subjuntiu present de 'faire' (2a persona plural) — 'vouloir que' demana subjuntiu." },
    { prompt: "Tout en ________ la vérité, il s'est tu. (savoir)", answer: "sachant", explanation: "Gerundi — 'Tout en + participi present' expressa concessió: 'tot i sabent'." },
    { prompt: "Quand tu arriveras, nous ________ déjà mangé. (avoir)", answer: "aurons", explanation: "Futur anterior — auxiliar 'avoir' al futur simple. Marca anterioritat futura." },
    { prompt: "Je suis content que tu ________ réussi. (avoir)", answer: "aies", explanation: "Subjuntiu passat — auxiliar 'avoir' al subjuntiu present. 'Être content que' demana subjuntiu." }
];
